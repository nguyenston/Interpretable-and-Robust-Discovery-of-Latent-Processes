...
\begin{frontmatter}
	...
	\begin{aug}
		\author[SE]{\fnms{Nguyen} \snm{Nguyen}\ead[label=nn]{nguyenpn@bu.edu}},
		% \author[MS]{\fnms{Jiawei} \snm{Li}\ead[label=jl]{jwli@bu.edu}},
		...
		\author[ECE]{\fnms{Brian} \snm{Kulis}\ead[label=bk]{bkulis@bu.edu}}
		\and
		\author[SE]{\fnms{Alex} \snm{Olshevsky}\ead[label=ao]{alexols@bu.edu}}

		\address[SE]{Division of Systems Engineering, Boston University, USA \printead{nn,yp,ao}}
		...
		\address[ECE]{Department of Electrical \& Computer Engineering, Boston University, USA \printead{bk}}
	\end{aug}
